  ...
  return (
    <div className='mt-24 flex items-center justify-center'>
        ...
        <div className='max-w-3xl w-full text-center space-y-6 '>
            ...
            <p className='text-lg'>Tell me what you want and I'll handle it : Hotels, Flights, Trip planning all - all in seconds</p>
            {/* Input Box */}
            <div>
                <div className='border rounded-2xl p-4 relative'>
                    <Textarea placeholder='Create a trip from Pune to Paris'
